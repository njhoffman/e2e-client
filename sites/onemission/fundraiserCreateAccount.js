...
const exec = () => {
  client
    ...
    .waitForVisible('#signup-form', 9000)
    ...
    .waitForVisible('#startfund-form', 9000)
  ...
  // fundraiser admin area
    .waitForVisible('#setupfund-form', 9000)
  ...
  // step 1
    ...
    .click(saveButton)
  // step 2
    .waitForVisible('input[name="fundraiser_goal_amount"]', 9000)
  ...
  // step 3
    ...
    .click(saveButton)
  // step 4
    .waitForVisible('button.add-image', 9000)
  ...
  // step 5
    .waitForVisible('textarea[name="thank_you_message"]', 9000)
    .then(() => saveScreenshot('Step 5'))
    .setValue('textarea[name="thank_you_message"]', faker.lorem.paragraph())
    .click(saveButton)
  // step 6
    .waitForVisible('input[name="leader_organization"]', 9000)
    ...
    .click(saveButton)
  // step 7
    .waitForVisible('input[name="fundraiser_website"]', 9000)
    .then(() => saveScreenshot('Step 7'))
    .click(saveButton)
  // step 8
    .waitForVisible('input[name="custom_apparel"]', 9000)
